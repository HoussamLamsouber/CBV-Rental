...
export const SearchForm = ({ onSearch }: SearchFormProps) => {
  ...
  const locations = {
    airports: [
      { value: 'Agadir-Al Massira (AGA)', label: 'Agadir-Al Massira (AGA)' },
      { value: 'Al Hoceïma-Cherif Al Idrissi (AHU)', label: 'Al Hoceïma-Cherif Al Idrissi (AHU)' },
      { value: 'Béni Mellal (BEM)', label: 'Béni Mellal (BEM)' },
      { value: 'Casablanca-Mohammed V (CMN)', label: 'Casablanca-Mohammed V (CMN)' },
      { value: 'Dakhla (VIL)', label: 'Dakhla (VIL)' },
      { value: 'Errachidia-Moulay Ali Chérif (ERH)', label: 'Errachidia-Moulay Ali Chérif (ERH)' },
      { value: 'Essaouira-Mogador (ESU)', label: 'Essaouira-Mogador (ESU)' },
      { value: 'Fès-Saïss (FEZ)', label: 'Fès-Saïss (FEZ)' },
      { value: 'Guelmim (GLN)', label: 'Guelmim (GLN)' },
      { value: 'Laâyoune-Hassan I (EUN)', label: 'Laâyoune-Hassan I (EUN)' },
      { value: 'Marrakech-Ménara (RAK)', label: 'Marrakech-Ménara (RAK)' },
      { value: 'Nador-Al Aroui (NDR)', label: 'Nador-Al Aroui (NDR)' },
      { value: 'Ouarzazate (OZZ)', label: 'Ouarzazate (OZZ)' },
      { value: 'Oujda-Angads (OUD)', label: 'Oujda-Angads (OUD)' },
      { value: 'Rabat-Salé (RBA)', label: 'Rabat-Salé (RBA)' },
      { value: 'Tanger-Ibn Battouta (TNG)', label: 'Tanger-Ibn Battouta (TNG)' },
      { value: 'Tétouan-Sania Ramel (TTU)', label: 'Tétouan-Sania Ramel (TTU)' },
      { value: 'Zagora (OZG)', label: 'Zagora (OZG)' },
      { value: 'Tan Tan (TTA)', label: 'Tan Tan (TTA)' },
      { value: 'Smara (SMW)', label: 'Smara (SMW)' },
      { value: 'Bouarfa (UAR)', label: 'Bouarfa (UAR)' },
      { value: 'Benslimane (GMD)', label: 'Benslimane (GMD)' },
      { value: 'Ifrane (IFR)', label: 'Ifrane (IFR)' },
      { value: 'Casablanca-Tit Mellil (CAS)', label: 'Casablanca-Tit Mellil (CAS)' },
    ],
    stations: [
